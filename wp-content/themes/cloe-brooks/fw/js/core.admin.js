/**
 * Cloe Brooks Framework: Admin scripts
 *
 * @package	cloe_brooks
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		cloe_brooks_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.cloe_brooks_course_selector').on('click', function(e) {
		"use strict";
...
function cloe_brooks_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = cloe_brooks_get_listbox_selected_value(cat_fld.get(0));

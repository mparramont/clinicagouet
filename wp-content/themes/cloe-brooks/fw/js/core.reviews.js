		...
		jQuery(this)
            ...
            .on('click', 'a', function(e) {
				...
				marks_panel.find('input[type="hidden"]').each(function (idx) {
					...
					CLOE_BROOKS_STORAGE['reviews_marks'][idx] = Math.round(((CLOE_BROOKS_STORAGE['reviews_marks'].length>idx && CLOE_BROOKS_STORAGE['reviews_marks'][idx]!='' 
						? parseFloat(CLOE_BROOKS_STORAGE['reviews_marks'][idx])*CLOE_BROOKS_STORAGE['reviews_users'] 
						: 0) + mark) / (CLOE_BROOKS_STORAGE['reviews_users']+1)*prec)/prec;
